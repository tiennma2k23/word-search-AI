...
from myproject.word_generator.mask import *
from myproject.word_generator.bitmap import *
from myproject.word_generator.ellipse import Ellipse
from myproject.word_generator.polygon import Polygon, Rectangle, RegularPolygon, Star
